...
export function WhatsAppWidget() {
  ...
  const phoneClean = '+918137865257'.replace(/[^0-9]/g, '');
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 font-sans">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-16 right-0 w-72 sm:w-80 rounded-2xl border border-emerald-500/30 bg-[#0f172a]/95 p-5 shadow-2xl backdrop-blur-xl text-slate-100"
          >
            {/* Header */}
      ...
      <button
        ...
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-slate-950/90 border border-emerald-500/40 text-emerald-400 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:border-emerald-400 hover:bg-[#0f172a] shrink-0"
        aria-label="Open WhatsApp live chat"
      >
        {/* Steady Online Status Indicator */}
